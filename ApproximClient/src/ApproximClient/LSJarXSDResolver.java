...
/**
 * Resolves xsd-requests by also using class.getResourceAsStream (Acknowledgement: Comments in this file copied and or adapted from the
 * Xerces library.)
 * 
...
public class LSJarXSDResolver implements LSResourceResolver, XMLEntityResolver {
     ...
     * The <code>LSParser</code> will call this method before opening any external resource, including the external DTD subset, external
     * entities referenced within the DTD, and external entities referenced within the document element (however, the top-level document
     * entity is not passed to this method). The application may then request that the <code>LSParser</code> resolve the external resource
     * itself, that it use an alternative URI, or that it use an entirely different input source.
     * 
     * @param type The type of the resource being resolved.
     * @param namespaceURI The namespace of the resource being resolved.
     * @param publicId The public identifier of the external entity being referenced, or <code>null</code> if no public identifier was
     ...
     *            external resource being referenced, or <code>null</code> if no system identifier was supplied.
     * @param baseURI The absolute base URI of the resource being parsed, or <code>null</code> if there is no base URI.
     * @return A <code>LSInput</code> object describing the new input source, or <code>null</code> to request that the parser open a regular
    ...
    public LSInput resolveResource(String type, String namespaceURI,
        ...
        if (otherLSResourceResolver != null) {
            LSInput res = otherLSResourceResolver.resolveResource(type,
                                                                  ...
                                                                  baseURI);
            if (res != null
                    && (res.getByteStream() != null || res.getCharacterStream() != null)) {
                return res;
            }
        }
     ...
     * @throws IOException Thrown if resolved entity stream cannot be opened or some other i/o error occurs.
    ...
    public XMLInputSource resolveEntity(XMLResourceIdentifier resourceIdentifier)
        ...
        if (otherXMLEntityResolver != null) {
            XMLInputSource res = otherXMLEntityResolver
...
class StreamInput extends XMLInputSource implements LSInput {
    ...
    /**
     * The base URI to be used (see section 5.1.4 in [<a href='http://www.ietf.org/rfc/rfc2396.txt'>IETF RFC 2396</a>]) for resolving a
     * relative <code>systemId</code> to an absolute URI. <br>
    ...
    /**
     * If set to true, assume that the input is certified (see section 2.13 in [<a href='http://www.w3.org/TR/2003/PR-xml11-20031105/'>XML
     * 1.1</a>]) when parsing [<a href='http://www.w3.org/TR/2003/PR-xml11-20031105/'>XML 1.1</a>].
     */
