...
public class MissingDeclarationException extends SemanticException {
     ...
     */
    public MissingDeclarationException(Declaration declaration,
            String information) {
     ...
     * 
     * @param scope the ParsedDeclaration missing this declaration (or null if it is the top scope).
     */
    ...
    public String toString() {
        if (this.scope != null) {
            return this.scope.getPos().toString() + ": '"
                    + this.scope.getType().getName() + "' requires a '"
                    + this.declaration.getName() + "' entry. " + information;
        } else {
