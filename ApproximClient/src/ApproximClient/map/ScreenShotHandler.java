...
public class ScreenShotHandler extends Thread {
    ...
    /**
     * The run methor of this thread, will show a filedialog and save the image.
     */
    public void run() {
        ...
        if (gotFilters) {
            if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION
                ...
                try {
                    javax.imageio.ImageIO.write(this.image, filter.getFormat(),
                                                file);
                } catch (IOException e) {
    ...
    /**
     * Adds filters to the fileChooser. Returns true if any filters are added (false otherwise).
     * 
    ...
    boolean addFilters(JFileChooser fileChooser) {
        ...
        ImageTypeSpecifier type = new ImageTypeSpecifier(this.image);
...
class ImageFilter extends FileFilter {
    ...
    /**
     * Creates a suffix array based upon known suffixes of the provided format. (BUG: It appears to be a mystery how to get imageio to
    ...
    /**
     * Returns true if the provided file matches any of the suffixes of this filter.
     * 
    ...
    /**
     * Returns a instance of the specified file with suffix to the provided file in case it can't find any.
     * 
    ...
    public File addSuffix(File file) {
        ...
        if (getSuffix(file) == null && suffixes != null && suffixes.length > 0) {
