...
public class UPSConversion {
    ...
    /**
     * This method converts geodetic (latitude and longitude) coordinates to UPS (hemisphere, easting, and northing) coordinates, according
     * to the current ellipsoid parameters.
     * 
     * @param latitude latitude in radians.
     * @param longitude longitude in radians.
     * @return UPS coordinate.
     */
    public static UPSCoordinate convertGeodeticToUPS(double longitude,
            double latitude) {
        char hemisphere;
        ...
        boolean succ = PolarStereographicProjection
                .setPolarStereographicParameters(ups_origin_latitude,
                                                 ups_origin_longitude,
                                                 false_easting, false_northing);
        double[] east_north = PolarStereographicProjection
                .convertGeodeticToPolarStereographic(longitude, latitude);
    ...
    /**
     * This method converts ups (hemisphere, easting, and northing) coordinates to geodetic (latitude and longitude) coordinates according
     * to the current ellipsoid parameters.
     * 
    ...
    public static double[] convertUPSToGeodetic(UPSCoordinate upsc) {
        ...
        ups_origin_latitude = (hemisphere == 'N') ? MAX_ORIGIN_LAT
                : -MAX_ORIGIN_LAT;
        ...
        boolean succ = PolarStereographicProjection
                .setPolarStereographicParameters(ups_origin_latitude,
                                                 ...
                                                 ups_false_easting,
                                                 ups_false_northing);
        double[] lon_lat = PolarStereographicProjection
                .convertPolarStereographicToGeodetic(easting, northing);
