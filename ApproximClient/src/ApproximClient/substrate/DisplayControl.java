...
public class DisplayControl {
     ...
     * The panning button.
     */
    private final JToggleButton panButton = new JToggleButton(new ImageIcon(
            SubstrateMapDrawer.class.getResource("images/pan24.png")));
    /**
     ...
     */
    private final JToggleButton fillButton = new JToggleButton(new ImageIcon(
            SubstrateMapDrawer.class.getResource("images/fillArea.png")));
    /**
     * The button used to remove the last added shape.
     */
    private final JButton undoButton = new JButton(new ImageIcon(
            SubstrateMapDrawer.class.getResource("images/undo24.gif")));
    /**
     * The button used for circle creation.
     */
    private final JToggleButton circleButton = new JToggleButton(new ImageIcon(
            SubstrateMapDrawer.class.getResource("images/circle.png")));
    /**
     * The button used for rectangle creation.
     */
    private final JToggleButton rectButton = new JToggleButton(new ImageIcon(
            SubstrateMapDrawer.class.getResource("images/rectangle.png")));
    /**
     * The button used for polygon creation.
     */
    private final JToggleButton polygonButton = new JToggleButton(
            new ImageIcon(
                    SubstrateMapDrawer.class.getResource("images/polygon.png")));
    /**
     * The button used for inserting new point into polygon.
     */
    private final JToggleButton newPointButton = new JToggleButton(
            new ImageIcon(SubstrateMapDrawer.class
                    .getResource("images/newpoint.png")));
    /**
     * The button used for moving point of a polygon.
     */
    private final JToggleButton movePointButton = new JToggleButton(
            new ImageIcon(
                    SubstrateMapDrawer.class
                            .getResource("images/movepoint.png")));
    /**
     * The button used for moving a shape.
     */
    private final JToggleButton moveShapeButton = new JToggleButton(
            new ImageIcon(
                    SubstrateMapDrawer.class.getResource("images/hand.png")));
    /**
     * The menu item used to import process variables.
     */
    private final JMenuItem importPVItem = new JMenuItem(
     ...
     */
    private final JMenuItem createFactionItem = new JMenuItem(
            "Add/remove Factions");
    /**
     * The menu item used to show the options dialog for the color map.
     */
    private final JMenuItem colorMapOptionsItem = new JMenuItem(
            "Color Map Options");
    ...
    public JPanel createNavigationPanel() {
        ...
        panButton.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                drawer.setPanningMode((((JToggleButton) e.getSource())
                        .isSelected()) ? true : false);
            }
        });
        panPanel.add(panButton);
        panPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
        ...
        navigationPanel.add(drawer.getZoomAndScaleController()
                .getZoomingPanel(), BorderLayout.CENTER);
    ...
    public JPanel createPVPanel() {
        ...
        pvPanel.add(substrateEditor.getProcessVariableHandler().getPanel(),
                    BorderLayout.WEST);
        pvPanel.add(substrateEditor.getFactionHandler().getPanel(),
                    BorderLayout.EAST);
    ...
    /**
     * Creates the panel which contains different buttons used to create new shapes as well as to set values to the existing shapes.
     */
        ...
        newPointButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                if (drawer.getSubstrateMode() != SubstrateMapDrawer.INSERT_POINT_MODE) {
                    ...
                    if (drawer.getShapeMaker() != null) {
                        PolygonMaker pMaker = (PolygonMaker) drawer
                                .getShapeMaker();
                        pMaker.addLastLine();
                    }
                    // disable panning
        ...
        moveShapeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                if (drawer.getSubstrateMode() != SubstrateMapDrawer.MOVE_POLYGON_MODE) {
                    ...
                    // check if the polygonial is completed
                    if (drawer.getShapeMaker() != null
                            && drawer.getShapeMaker() instanceof PolygonMaker) {
                        PolygonMaker pMaker = (PolygonMaker) drawer
                                .getShapeMaker();
                        pMaker.addLastLine();
                    }
...
//         sButtons.add(moveShapeButton);
    ...
    public JPanel createTextFieldPanel() {
        ...
        JTextField infoTextField = substrateEditor.getSubstrateDrawer()
                .getCurrentLocationTextField();
        infoTextField.setEditable(false);

        // text field for the region under the mouse cursor
        JTextField regionTextField = substrateEditor.getSubstrateDrawer()
                .getCurrentRegionTextField();
    ...
    public JMenuBar createMenuBar() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                Thread thread = new Thread() {
                    public void run() {
                        ...
                        sEditor.exit();
                        // show main frame
                        final ClientMainFrame mainFrame = sEditor.getClient()
                                .getClientMainFrame();
                        SwingUtilities.invokeLater(new Runnable() {
                            public void run() {
                                mainFrame.pack();
        ...
        new JToggleButton(new ImageIcon(
                SubstrateMapDrawer.class.getResource(path + "shape.png")));
        ...
        createFactionItem.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent event) {
                CreateFactionDialog.showDialog(sEditor.getSubstrateDrawer()
                        .getFrame(), sEditor.getFactionHandler());
            }
        });
        colorMapOptionsItem.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent event) {
                ColorMapDialog.showDialog(sEditor.getProcessVariable(), sEditor
                        .getSubstrateDrawer().getFrame(), sEditor
                        .getColorChooser());
            }
        });
