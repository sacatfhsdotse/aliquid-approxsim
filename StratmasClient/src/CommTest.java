          ...
          try {
               ...
               while(line != null && !line.equalsIgnoreCase("q")) {
                    if (line.equalsIgnoreCase("c") && conn == false) {
                         ...
                         root = StratmasObjectFactory.createList(TypeFactory.getType("Root").getSubElement("identifiables"));
                         StratmasObject sim = Client.importXMLSimulation("misc/" + filename);
                         ...
                         StratmasObject list = 
                             StratmasObjectFactory.createList(TypeFactory.getType("Root").getSubElement("identifiables"));
                         ...
                         fromFile = !fromFile;
                         System.out.println("input now from " + (fromFile ? "file" : "program"));
                    }
                    else if (line.equals("t")) {
                         xh.test(getMsgFromFile("/scratch/test.xml"));
                    }
                    else if (!line.equals("")) {
                         System.out.println("Command '" + line + "' unknown or currently invalid");
                    }
              ...
              System.err.println("ServerException while communicating: " + e.getMessage());
          }
...
class MyXMLHandler extends XMLHandler {
     ...
     public void test(String xml) {
          try {
               ...
               if (elem != null) {
                    StratmasObject o =
                         StratmasObjectFactory.domCreate(getFirstChildByTag(elem, "object"));
