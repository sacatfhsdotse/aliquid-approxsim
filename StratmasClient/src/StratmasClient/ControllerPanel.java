...
/**
 * This panel controls the simulation. It contains buttons for connect/disconnect the client to/from the
 * server, start/stop the simulation, pause/continue the simulation, step forward one time step
 * and exit the simulation. It should exist one control panel for each client. 
 *
 * @version 1.0
...
public class ControllerPanel extends JPanel implements ActionListener {
    ...
    public ControllerPanel(Client client, Controller controller) {
        ...
        startStop.setIcon(new ImageIcon(ControllerPanel.class.getResource(path+"Play16.gif")));
        startStop.setActionCommand("start");
        startStop.setToolTipText("Start the simulation");
        startStop.addActionListener(this);
        startStopPanel.add(startStop);
        startStopPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Start/Stop"),
                                                                    BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        // puase/continue button
        JPanel pauseContPanel = new JPanel();
        pauseCont = new JButton(new ImageIcon(ControllerPanel.class.getResource(path+"Pause16.gif")));
        ...
        TitledBorder pauseBorder = BorderFactory.createTitledBorder("Pause/Continue");
        pauseContPanel.setBorder(BorderFactory.createCompoundBorder(pauseBorder, BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        pauseContPanel.setPreferredSize(pauseBorder.getMinimumSize(pauseContPanel));
        
        // step forward button
        JPanel stepPanel = new JPanel();
        step = new JButton(new ImageIcon(ControllerPanel.class.getResource(path+"StepForward16.gif")));
        step.setToolTipText("Step forward");
        step.addActionListener(this);
        stepPanel.add(step);
        stepPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Step Forward"),
                                                               BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        ...
        if (client.getServerConnection() != null && client.getServerConnection().isAlive()) {
        ...
        TitledBorder connectBorder = BorderFactory.createTitledBorder("Connect/Disconnect");
        connectPanel.setBorder(BorderFactory.createCompoundBorder(connectBorder, BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        connectPanel.setPreferredSize(connectBorder.getMinimumSize(connectPanel));
        ...
        exitPanel.add(exit);
        exitPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Exit"),
                                                               BorderFactory.createEmptyBorder(0, 10, 0, 10)));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source.equals(startStop)) {
            if (((JButton)source).getActionCommand().equals("start")) {
                startStop.setIcon(new ImageIcon(ControllerPanel.class.getResource(path+"Stop16.gif"))); 
                ...
                if (answer == JOptionPane.YES_OPTION) {
                    ...
                    // reset pause button
                    pauseCont.setIcon(new ImageIcon(ControllerPanel.class.getResource(path+"Pause16.gif")));
                    pauseCont.setToolTipText("Pause the simulation");
                    pauseCont.setActionCommand("pause");
                }
            }
        ...
        else if (source.equals(pauseCont) && startStop.getActionCommand().equals("stop")) {
            if (((JButton)source).getActionCommand().equals("pause")) {
                pauseCont.setIcon(new ImageIcon(ControllerPanel.class.getResource(path+"Play16.gif")));
    ...
    private int exitMess() {
        ...
        int answer = StratmasDialog.showOptionDialog(null, "Are you sure you want to exit?", 
    ...
    private int disconnectMess() {
        Object[] options = {"Yes", "No"}; 
        int answer = StratmasDialog.showOptionDialog(null, "Are you sure you want to disconnect?", 
                                                     "Question message", JOptionPane.YES_NO_OPTION, 
                                                     JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        return answer;
    }
    ...
    private int stopMess() {
        ...
        int answer = StratmasDialog.showOptionDialog(null, msg,
                                                     "Question message", JOptionPane.YES_NO_OPTION, 
                                                     JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        return answer;
    }
