...
public class IconFactory {
     ...
     */
    static Icon leafIcon = new Icon(
            IconFactory.class.getResource("icons/leaf.png"));

    /**
     * Default icon for nonleafs;
     */
    static Icon nonLeafIcon = new Icon(
            IconFactory.class.getResource("icons/nonleaf.png"));
    ...
    public static Icon getIcon(StratmasObject object) {
        ...
        if (res != null) {
            ...
            if (object.getType().canSubstitute("Activity")) {
                ...
                if (mu != null) {
                    return getActivityIcon((SymbolIDCode) mu
        ...
        if (typeMapping == null) {
            ...
            typeMapping
                    .put("UniformDistribution",
                         new Icon(IconFactory.class
                                 .getResource("icons/uniformdistribution.png")));
            typeMapping.put("Curve",
                            new Icon(IconFactory.class
                                    .getResource("icons/curve.png")));
            typeMapping.put("Point",
                            new Icon(IconFactory.class
                                    .getResource("icons/point.png")));
            typeMapping.put("Disease",
                            new Icon(IconFactory.class
                                    .getResource("icons/disease.png")));
            ...
            typeMapping.put("Scenario",
                            new Icon(IconFactory.class
                                    .getResource("icons/scenario.png")));
            typeMapping.put("Circle",
                            new Icon(IconFactory.class
                                    .getResource("icons/circle.png")));
            typeMapping.put("Shape",
                            new Icon(IconFactory.class
                                    .getResource("icons/shape.png")));
        }
    }

    /**
     * Returns an icon representing the type of the provided object (or null if no such found)..
     * 
    ...
    /**
     * Returns an app6a icon representing the provided symbolIDCode (or null if no such found)..
     * 
    ...
    /**
     * Returns the activity icon. OBS. Potential memory leak - there is a risk that the keys and weak references in activitySymbols list are
    ...
    public static Icon getActivityIcon(SymbolIDCode code, Image src) {
        int affChar = (code == null || code.valueToString().length() < 2) ? '-'
                : code.valueToString().charAt(1);
