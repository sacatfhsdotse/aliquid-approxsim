...
public class StratmasDialog {
    ...
    /**
     * Preprocesses a message to be shown in a dialog. If the message  is a String it is wrapped inside a JTextArea 
     * so that it will be possible to copy the text from the dialog.
     *
