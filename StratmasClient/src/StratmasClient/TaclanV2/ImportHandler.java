...
public abstract class ImportHandler {
     ...
     */
    public abstract ParsedDeclaration getParsedDeclaration(
            ParsedReference reference) throws ImportHandlerException;

    /**
     * Returns a ParsedDeclarationList containing all declarations
     */
    public abstract ParsedDeclarationList getParsedDeclarationList()
