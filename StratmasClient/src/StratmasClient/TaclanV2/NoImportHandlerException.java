...
/**
 * An object representing the incapability of importing a format into TaclanV2
 * 
...
public class NoImportHandlerException extends Exception {
     ...
     * @param errors a vector containing the error messages from the different handlers.
     */
    ...
    public String getMessage() {
        ...
        buf.append("No handler is capable of handling \"" + this.location
                + "\n Details as follows:\n");
        for (Enumeration es = this.errors.elements(); es.hasMoreElements();) {
            ImportHandlerException e = (ImportHandlerException) es
                    .nextElement();
