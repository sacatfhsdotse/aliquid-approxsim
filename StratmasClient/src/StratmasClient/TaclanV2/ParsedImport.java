...
/**
 * An object representing an importation in the Taclan V2 language. It is responsible to deliver a ParsedDeclaration or
 * ParsedDeclarationList based on the resource given in the constructor.
 * 
...
public class ParsedImport extends ParsedObject {
    ...
    /**
     * Tries to make and return the location of the target for the import relative to the location where the import statement was made.
...
class ImportHandlerFactory {
    ...
    /**
     * Returns the first availiable handler stating that it is capable of handling the location.
     */
    public ImportHandler getHandler(String location)
            throws NoImportHandlerException {
        ...
        for (int i = 0; i < handlers.length; i++) {
            ...
            try {
                Constructor constructor = handler
                        .getConstructor(new Class[] { location.getClass() });
                ImportHandler handlerInstance = (ImportHandler) constructor
                        .newInstance(((Object[]) new String[] { location }));
