...
public class TimeSliderDebugFrame extends JFrame {
    ...
    /**
     * The execution time of the ten last time steps (where execution time is counted from the message is sent to the answer is handled by
     * the XMLHandler).
     */
    ...
    /**
     * The index in the mStepTimes array to put the next execution time in.
     */
    ...
    /**
     * The label showing the approximate wall clock time between time steps.
     */
    JLabel mLabel;
    /**
    ...
    public TimeSliderDebugFrame() {
        ...
        timeSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                ...
                if (!source.getValueIsAdjusting()) {
                    mLabel.setText(mFormat.format((mMeanStepTime + source
                            .getValue()) / 1000.0));
        ...
        timeSliderPanel.setLayout(new BoxLayout(timeSliderPanel,
                BoxLayout.Y_AXIS));
     ...
     * 
     * @return The current value of the slider, i.e. the time to wait between two consecutive step messages.
     */
