...
/**
 * A thread safe priority queue with both blocking and non-blocking
 * dequeue. The queue has FIFO behaviour when two Objects A and B are
...
public class PriorityQueue<T> {
    ...
    public synchronized void clear() {
     ...
     /**
      * Dequeues the Object with the highest priority or if the queue
      * is empty - block until an Object is enqueued by another thread.
      * 
    ...
    public int size() {
     ...
     /**
      * A class used as key in a PriorityQueue. The ordering between
      * two keys A and B is as follows: A is less than B if A's
