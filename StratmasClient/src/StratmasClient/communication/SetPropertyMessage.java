...
/**
 * Class representing the SetPropertyMessage. The SetPropertyMessage is used to set different properties for the server.
 * 
...
public class SetPropertyMessage extends StratmasMessage {
    ...
    public StringBuffer bodyXML(StringBuffer b) {
        b.append(NL).append("<property>").append(mProperty)
                .append("</property>");
