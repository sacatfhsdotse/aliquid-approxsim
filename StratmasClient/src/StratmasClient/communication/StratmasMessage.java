 ...
 * between the vlient and the server.
 *
...
//          b.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
          ...
          b.append("<sp:stratmasMessage xmlns:sp=\"").append(StratmasConstants.stratmasNamespace);
          b.append("\" xmlns:xsi=\"").append(StratmasConstants.xmlnsNamespace).append("\" ");
     ...
     /**
      * Fires an event telling that the answer to this message has
      * been received.
      */
     ...
     public void fireMessageHandled(Object reply) {
          ...
          for (int i = listeners.length - 2; i >= 0; i -= 2) {
               ((StratmasMessageListener) listeners[i + 1]).messageHandled(event, reply);
          }
     }

     /**
      * Fires an event telling that something went wrong during the
      * sending, answer-receiving or answer-handling of this message.
      */
