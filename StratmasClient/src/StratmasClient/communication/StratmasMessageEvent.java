...
/**
 * This class represents the events that may be sent by a StratmasMessage to indicate the progress of the message. Events are currently sent
...
public class StratmasMessageEvent extends java.util.EventObject {
     ...
     * Constructor
     * 
     * @param source The source of the event, i.e. the StratmasMessage that generated the event.
     */
