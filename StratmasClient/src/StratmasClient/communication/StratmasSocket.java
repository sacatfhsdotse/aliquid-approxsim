 ...
 * <p>
 * where 'length' is a 64 bit network byte order integer representing the length of the xml contents , 'id' is a 64 bit network byte order
 * integer representing the id of the session (or -1 if the socket is not yet connected) and 'xml content' is 'length' bytes of data
 * representing the xml contents of the message.
 * 
...
public class ApproxsimSocket {
    ...
    public int getPort() {
        if (mSocket != null
                && mSocket.getRemoteSocketAddress() != null
    ...
    /**
     * Sets the id of this session if one want to connect to a simulation that is running in detached mode.
     * 
