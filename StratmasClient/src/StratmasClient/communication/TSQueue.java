...
/**
 * A thread safe queue with both blocking and non-blocking dequeue.
 * 
...
public class TSQueue {
    ...
    /**
     * Dequeues the Object at the front of the queue or if the queue is empty - block until an Object is enqueued by another thread.
     * 
