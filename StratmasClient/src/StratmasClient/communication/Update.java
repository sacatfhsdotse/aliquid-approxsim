...
public class Update {
    ...
    public Update(StratmasObject o, String type) {
        ...
        if (type.equals(UpdateMessage.ADD)) {
            xml.append(XMLHelper.NL).append("<identifiable xsi:type=\"sp:")
                    .append(o.getType().getName());
            xml.append("\" identifier=\"").append(o.getIdentifier())
                    .append("\">");
            o.bodyXML(xml);
            xml.append(XMLHelper.NL).append("</identifiable>");
        } else if (type.equals(UpdateMessage.REPLACE)) {
            xml.append(XMLHelper.NL).append("<newObject xsi:type=\"sp:")
                    .append(o.getType().getName());
            xml.append("\" identifier=\"").append(o.getIdentifier())
                    .append("\">");
            o.bodyXML(xml);
            ...
            xml.append(XMLHelper.NL).append("<newValue xsi:type=\"sp:")
                    .append(o.getType().getName());
            xml.append("\" identifier=\"").append(o.getIdentifier())
                    .append("\">");
            o.bodyXML(xml);
