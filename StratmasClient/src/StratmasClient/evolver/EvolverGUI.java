...
/**
 * EvolverGUI is a class presenting the progress of an
 * evolver. It also contains visual objects used to control and
...
public class EvolverGUI extends JTabbedPane
{
    ...
    /**
     * Creates a new EvolverGUI using the provided object as the root
     * of the tree being evolved.
     */
    ...
    /**
     * Creates a panel whith evolver configuration controls using the
     * provided object as root.
     *
    ...
    /**
     * Logs interesting temporary messages for eventual consumption by
     * the user.
     *
     * @param message the message.
     */
    ...
    /**
     * Returns the AbstractAction for the string, or null if no such
     * action.
     *
...
abstract class EvolverAction extends AbstractAction implements EvolverEventListener
{
     ...
     *
     * @param evolver the evolver this action controls (may be null in
     * which case the action is disabled.)
