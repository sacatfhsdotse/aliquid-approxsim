...
/**
 * Provides Sampler instances by collecting bits and pieces from Gui
 * components.
 *
...
public class GuiSamplerFactory extends JPanel implements SamplerFactory 
{
    ...
    /**
     * Creates a new SamplerFactory letting the user configure the
     * various components of an Sampler.
     */
    ...
    /**
     * Returns true if the samplers created by this factory should be
     * minimizing
     */
    ...
    /**
     * Sets whether the samplers created by this factory should be
     * minimizing or not.
     *
