...
/**
 * Represents a parameter. E. g. if f(x, y, z) is used, the corresponding Parameters would be: <code>Parameter("x")</code>,
 * <code>Parameter("y")</code> and <code>Parameter("z")</code>. The class is abstract to force people to think before not overriding the
 * default implementations of getComparator and getMetric.
 * 
...
public abstract class Parameter implements ParameterInstanceFactory {
    ...
    /**
     * Returns a ParameterInstance of this Parameter given the provided Object. Returns null if this Parameter don't support the provided
     * object.
     * 
     ...
     */
    public abstract ParameterInstance getGradientNeighbour(
            ParameterInstance instance, double gradient);
}
