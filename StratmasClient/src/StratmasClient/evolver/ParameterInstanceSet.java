...
/**
 * A ParameterInstanceSet is a set of parameter instances, used to contain the definition set of a sample. E. g. if f(x, y, z) were sampled
 * at (1, 2, 3) the corresponding ParameterInstanceSet would contain the key->value pairs x->1, y->2 and z->3
 * 
...
public class ParameterInstanceSet extends Hashtable {
    ...
    /**
     * Adds a new parameter instance to the set (silently replacing any existing parameter with the same name).
     * 
    ...
    /**
     * Returns the instance of the specified parameter or null if no parameter with that name.
     * 
