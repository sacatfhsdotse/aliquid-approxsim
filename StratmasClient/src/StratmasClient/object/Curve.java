...
public abstract class Curve extends StratmasObjectImpl {
    ...
    /**
     * Returns a set of lines approximating this curve within the specified error. N.B will only recalculate if old cached value has a
     * higher error than the previous.
     * 
    ...
    /**
     * Called when a (direct) child of this has changed. The default behaviour for Curve is to pass the event upwards in the tree.
     * 
