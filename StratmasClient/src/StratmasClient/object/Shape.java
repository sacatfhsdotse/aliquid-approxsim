...
/**
 * A shape defines a set of two dimensional points. It is built by enclosing regions with curves or by combining other shapes into a new
 * shape.
 * 
...
public abstract class Shape extends DefaultComplex {
     ...
     */
    public abstract Vector<SimpleShape> constructSimpleShapes(
            Vector<SimpleShape> res);
    ...
    /**
     * Returns bounding box of the shape with respect to it's projected parts. Obs that this bounding box depends on the given projection
     * and usually it's not equal to the bounding box obtained by getBoundingBox() method. In this box all the projected parts are inside
    ...
    /**
     * Creates a Shape from the specified Declaration. The default Shape is a Circle.
     * <p>
     * author Per Alexius
     * 
    ...
    /**
     * Called when a (direct) child of this has changed. The default behaviour for Shape is to pass the event upwards in the tree.
     * 
