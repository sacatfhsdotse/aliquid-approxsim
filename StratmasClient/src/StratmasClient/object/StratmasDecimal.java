...
/**
 * StratmasDecimal is a Stratmas adapter for floating point numbers (read doubles).
 * 
...
/**
 * StratmasDecimalGUIConstructor creates GUIs for creating StratmasDecimal objects.
 * 
 * @version 1, $Date: 2006/04/10 09:45:55 $
 * @author Daniel Ahlin
 */
class StratmasDecimalGUIConstructor extends StratmasGUIConstructor {
    ...
    protected void createStratmasObject() {
        try {
            setStratmasObject(new StratmasDecimal(this.declaration,
