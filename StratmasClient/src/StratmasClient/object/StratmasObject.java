...
/**
 * StratmasObject is the common origin of the objects handled by the
 * StratmasClient. The tree-handling methods of this class acts like a
 * leaf-node.
 *
...
public abstract class StratmasObject implements Transferable
{
    ...
    /**
     * Returns the declaration specifying this object, or null if no
     * such can be specified (e. g. if this object has no
     * parent). Note that the type of the returned declaration may be
     * a superclass of the actual type the object has.
     */
    ...
    /**
     * Returns the child at the specified index assuming the child is
     * enumerated by the objects type. Note that this means that
     * getChild(j) may return null while getChild(i) and getChild(k)
     * does not for i < j < k.
     * 
    ...
    /**
     * Returns the index of the provided child, according to the
     * declaration or -1 if none.
     * 
    ...
    /**
     * Adds a new child object to this object. If child with identical
     * identifier exists, the previous entry is removed.
     *
     *
     * @param part the StratmasObject to add.
    ...
    /**
     * Adds all children in provided vector to this object. If any
     * child with identical identifier already exists, the previous entry is
     * removed.
     *
     * <p>author  Daniel Ahlin
     *
    ...
    /**
     * Sets the parent of this object. Note that implementations of
     * this method have to make sure to call
     * StratmasObjectFactory.attached iff getParent()==null when
     * this function is called with a non-null argument.
     *
...
//     public abstract Vector getActions();
    ...
    /**
     * Returns the tag of this object (used for XML
     * representation). For some objects this will be the same as the
     * identifier. However for nonsingular objects it will be the tag
     * of the list holding them.
     */
    ...
    /**
     * Returns all elements that passes the provided filter declared
     * below this object.
     *
    ...
    /**
     * Adds all objects that passes the provided filter declared below
     * this object to the provided vector.
     *
     * @param filter the filter to use.
     ...
     * StringBuffer. Returns the same buffer.
     *
    ...
    /**
     * Returns the "youngest" common ancestor of this and the provided
     * other object, or null if none found.
     *
     ...
     */
    protected abstract void fireIdentifierChanged(String oldIdentifier, Object initiator);
     ...
     * (listeners on the child recieves a remove-event.).
     *
     ...
     * @param initiator the initiator of the change.
     */
    public abstract void fireChildChanged(StratmasObject changed, Object initiator);
