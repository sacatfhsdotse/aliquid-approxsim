...
public class PolygonMaker extends ShapeMaker {
     ...
     * @param lineAdapter line adapter of the line which is divided by the inserted point into two new lines.
     */
    ...
    public void moveShape(double lon, double lat) {
        ...
        if (box != null) {
            ...
            // polygonial area
            for (Enumeration<MapLineAdapter> e = lineAdapters.elements(); e
                    .hasMoreElements();) {
    ...
    protected BoundingBox getAreaBoundingBox() {
        ...
        if (!pointAdapters.isEmpty()) {
            Point p = (Point) ((MapDrawableAdapter) pointAdapters
            ...
            for (int i = 1; i < pointAdapters.size(); i++) {
                p = (Point) ((MapDrawableAdapter) pointAdapters.get(i))
                        .getObject();
    ...
    protected boolean isShapeSimple() {
        ...
        for (Enumeration e = ((Polygon) shapeAdapter.getObject()).getCurves(); e
                .hasMoreElements();) {
