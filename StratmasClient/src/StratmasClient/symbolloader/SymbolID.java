/*
 * A different approach to representing a SymbolID: how about keeping it as a bunch of
 * enumerations, since most fields are easily enumerated? This drops the explicit string
 * representation, instead converting to/from string when necessary.
*/
...
class SymbolID {
        ...
        static class EnumerationTable {
            ...
            protected void initFromFile(String fName)
            {
                ...
                try {
                    ...
                    System.out.println("EnumerationTable couldn't open " + fName + " -- won't work");
                }
            }
        ...
        static class CodingSchemeField extends EnumeratedField {
                private static final EnumerationTable theTable =
                        new EnumerationTable("CODING SCHEME",
                                             "S*:WARFIGHTING;G:TACTICAL GRAPHICS;" +
        ...
        static class AffiliationField extends EnumeratedField {
                private static final EnumerationTable theTable =
                        new EnumerationTable("AFFILIATION",
                                             "P:PENDING;U*:UNKNOWN;A:ASSUMED FRIEND;" +
                ...
                static String getIconAlias(final String affil) {
                        final String icon = "AFHJKONPSU",
                                    alias = "FFHHHONPHU";        // FIXME: Violates standard.
                        int i;
        ...
        static class BattleDimensionField extends EnumeratedField {
                private static final EnumerationTable theTable =
                        new EnumerationTable("BATTLE DIMENSION",
                                             "P:SPACE;A:AIR;G*:GROUND;S:SEA SURFACE;" +
        ...
        static class StatusField extends EnumeratedField {
                private static final EnumerationTable theTable =
                        new EnumerationTable("STATUS",
                                             "A:ANTICIPATED/PLANNED;P*:PRESENT");
                static public String[] getValues() {
                        return theTable.getValues();
                }
        ...
        static class FunctionIDField extends Field {
                ...
                public String encode() {
                        FunctionIDTree.FunctionIDNode fin = SymbolLoader.ftree.findByAddress(address);
                        if(fin != null) {
                ...
                public boolean decode(String sym) {
                        ...
                        fs.append(sym);
                        FunctionIDTree.FunctionIDNode fin = SymbolLoader.ftree.findBySymbolID(fs.toString());
                        if(fin != null) {
                ...
                public boolean isEquipment() {
                        for(int i = 0; i < equipPrefix.length; i++)
                                if(address.startsWith(equipPrefix[i]))
                                        return true;
                        return false;
                }
                ...
                public boolean isInstallation() {
                        for(int i = 0; i < instPrefix.length; i++)
                                if(address.startsWith(instPrefix[i]))
                                        return true;
                        return false;
                }
        ...
        static class SymbolModifierField extends Field {
                public static final int TYPE_UNIT_NONE = 0, TYPE_UNIT_HQ     = 1, TYPE_UNIT_TFHQ = 2,
                                        TYPE_UNIT_FDHQ = 3, TYPE_UNIT_FDTFHQ = 4, TYPE_UNIT_TF   = 5,
                                        TYPE_UNIT_FD   = 6, TYPE_UNIT_FDTF   = 7,
                                        TYPE_INSTALLATION = 8,
                                        TYPE_EQUIPMENT = 9, TYPE_TOWED = 10;
                ...
                public static final int EQUIP_NONE    = 0, EQUIP_WHEELED = 1, EQUIP_CROSSCOUNTRY = 2,
                                        EQUIP_TRACKED = 3, EQUIP_WHEELEDTRACKED = 4,
                                        EQUIP_TOWED   = 5, EQUIP_RAIL = 6, EQUIP_OVERTHESNOW = 7,
                                        EQUIP_SLED    = 8, EQUIP_PACKANIMALS = 9,
                ...
                protected boolean typeIsValid(int t) {
                        ...
                        else if(t == TYPE_EQUIPMENT)
                                return func.isEquipment();
                        return false;
                }
                ...
                public String encode() {
                        ...
                        int t = type < TYPE_INSTALLATION ? 0 : (type - TYPE_INSTALLATION) + 1;
        ...
        static class CountryCodeField extends EnumeratedField {
                private static final EnumerationTable theTable =
                    ...
                    new EnumerationTable("COUNTRY CODE", CountryCodeField.class.getResourceAsStream("fips10-4.txt"));
        ...
        static class OrderOfBattleField extends EnumeratedField {
                private static final EnumerationTable theTable =
                        new EnumerationTable("ORDER OF BATTLE",
        ...
        public static final int F_CODINGSCHEME = 0, F_AFFILIATION = 1, F_BATTLEDIMENSION = 2,
                        F_STATUS = 3, F_FUNCTIONID = 4, F_SYMBOLMODIFIER = 5,
                        F_COUNTRYCODE = 6, F_ORDEROFBATTLE = 7, F_NUMFIELDS = 8;
        private static final Class fieldClass[] = {
                CodingSchemeField.class, AffiliationField.class, BattleDimensionField.class,
                StatusField.class,         FunctionIDField.class,         SymbolModifierField.class,
                CountryCodeField.class,  OrderOfBattleField.class
        };
        ...
        public static Class getFieldClass(int id) {
                if(id >= 0 && id < fieldClass.length)
                        return fieldClass[id];
                return null;
        }
        ...
        public String getFieldValue(int i) {
                if(i >= 0 && i < field.length)
                        return field[i].encode();
                return null;
        }

        public boolean setField(int i, String s) {
                if(i >= 0 && i < field.length)
                        return field[i].decode(s);
                return false;
        }
        ...
        public int getMobility() {
                if(isEquipment()) {
                        return ((SymbolModifierField) field[F_SYMBOLMODIFIER]).getMobility();
                }
                return -1;
        }
