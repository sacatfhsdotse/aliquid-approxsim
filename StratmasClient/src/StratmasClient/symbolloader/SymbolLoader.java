/*
 * A SymbolLoader class, whose purpose is to provide bitmaps of symbols given a 15-character SymbolID code. Returns a Java standard
...
public class SymbolLoader implements MRUCache.Getter {
    ...
    /**
     * Returns the symbol associated with the provided symbol-id. This is the offical interface to use to load symbols. Cached in several
     * levels.
     * 
    ...
    public static final void main(String[] arg) {
        ...
        if (arg.length > 0) {
            ...
            System.err.println("Usage: java " + SymbolLoader.class.getName()
                    + " image-dir <syms...>");
            System.exit(1);
        }
    }
