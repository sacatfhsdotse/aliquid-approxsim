 ...
 */
public class TimelineCanvasPanel extends JPanel implements GLEventListener,
    ...
    /**
     * Returns the x-coordinate of the position under the mouse cursor expresed in the projected coordinate system.
     */
    ...
    protected void setCurrentCursorProjectedPos(int x) {
        ...
        currentCursorProjectedPos = (currentPos < xmin) ? xmin
                : (currentPos > xmax) ? xmax : currentPos;
    }
    ...
    protected double dt2dx(long dt) {
        ...
        double x2 = convertCurrentTimeToProjectedX(timelinePanel
                .millisecondsToTimeUnit(dt));
        return x2 - x1;
    }
