...
public class TimelineDisplayControl {
    ...
    private JPanel createAllTimesSelectionPanel() {
        ...
        selectionBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (thisBox.isSelected()) {
                    long startTime = (tline.getRelativeCurrentTime() == 0) ? tline
                            .getDT() : tline.getRelativeCurrentTime();
                    tline.updatePrenumerations(TimelineConstants.SELECT,
                                               new TimeInterval(tline.getDT(),
                                                       startTime,
                                                       Long.MAX_VALUE));
                ...
                // no times selected
                    ...
                    tline.updatePrenumerations(TimelineConstants.DELETE,
                                               new TimeInterval(tline.getDT(),
                                                       0, Long.MAX_VALUE));
                }
            }
        ...
        TitledBorder timeBorder = BorderFactory
                .createTitledBorder("Time Selection");
        selectionPanel.setBorder(BorderFactory
                .createCompoundBorder(timeBorder, BorderFactory
                        .createEmptyBorder(2, 2, 2, 2)));
        selectionPanel.setPreferredSize(timeBorder
                .getMinimumSize(selectionPanel));
    ...
    private JPanel createMilitaryUnitsForcePanel(TimelinePanel timelinePanel) {
        ...
        forcePanel.add(createMilitaryUnitsForceMenuBar(timelinePanel),
                       BorderLayout.CENTER);
        forcePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
                .createTitledBorder("Resource Size"), BorderFactory
                .createEmptyBorder(2, 2, 2, 2)));
        return forcePanel;
    }
    ...
    private JMenuBar createMilitaryUnitsForceMenuBar(TimelinePanel timelinePanel) {
        ...
        for (int i = 0; i < MapConstants.forceUnits.length; i++) {
            ...
            forceItems[i].setFont(forceItems[i].getFont()
                    .deriveFont(Font.PLAIN));
            // create a filter for each force
            final MilitaryCodeFilter codeFilter = new MilitaryCodeFilter(
                    MapConstants.forceSymbols[i], 11);
            final ActivityResourceFilter resourceFilter = new ActivityResourceFilter(
                    codeFilter);
            forceItems[i].addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    JCheckBoxMenuItem thisBox = (JCheckBoxMenuItem) e
                            .getSource();
                    if (thisBox.isSelected()) {
                        tlinePanel
                                .updateActivityTypeFilter(resourceFilter,
                                                          TimelineConstants.ADD);
                    } else {
                        tlinePanel
                                .updateActivityTypeFilter(resourceFilter,
    ...
    private JPanel createMilitaryUnitsMobilityPanel(TimelinePanel timelinePanel) {
        ...
        mobilePanel.add(createMilitaryUnitsMobilityMenuBar(timelinePanel),
                        BorderLayout.CENTER);
        mobilePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
                .createTitledBorder("Resource Mobility"), BorderFactory
                .createEmptyBorder(2, 2, 2, 2)));
        return mobilePanel;
    }
     ...
     */
    private JMenuBar createMilitaryUnitsMobilityMenuBar(
        ...
        for (int i = 0; i < MapConstants.mobileUnits.length; i++) {
            ...
            mobileItems[i].setFont(mobileItems[i].getFont()
                    .deriveFont(Font.PLAIN));
    ...
    public JPanel createActivityTimeSelectionPanel(TimelinePanel timelinePanel) {
        final TimelinePanel tlinePanel = timelinePanel;
        final ActivityTimeFilter pastFilter = new ActivityTimeFilter(timeline,
                ActivityTimeFilter.PAST);
        final ActivityTimeFilter presentFilter = new ActivityTimeFilter(
                timeline, ActivityTimeFilter.PRESENT);
        final ActivityTimeFilter futureFilter = new ActivityTimeFilter(
                timeline, ActivityTimeFilter.FUTURE);
        ...
        pastCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JCheckBox thisBox = (JCheckBox) e.getSource();
                if (thisBox.isSelected()) {
                    tlinePanel.updateActivityTimeFilter(pastFilter,
                                                        TimelineConstants.ADD);
                } else {
                    tlinePanel
                            .updateActivityTimeFilter(pastFilter,
                                                      TimelineConstants.REMOVE);
                }
            }
        });
        ...
        presentCheckBox.setFont(presentCheckBox.getFont()
                .deriveFont(Font.PLAIN));
        presentCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JCheckBox thisBox = (JCheckBox) e.getSource();
                if (thisBox.isSelected()) {
                    tlinePanel.updateActivityTimeFilter(presentFilter,
                                                        TimelineConstants.ADD);
                } else {
                    tlinePanel
                            .updateActivityTimeFilter(presentFilter,
                                                      TimelineConstants.REMOVE);
                }
            }
        });
        ...
        futureCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JCheckBox thisBox = (JCheckBox) e.getSource();
                if (thisBox.isSelected()) {
                    tlinePanel.updateActivityTimeFilter(futureFilter,
                                                        TimelineConstants.ADD);
                } else {
                    tlinePanel
                            .updateActivityTimeFilter(futureFilter,
                                                      TimelineConstants.REMOVE);
                }
            }
        });
        ...
        activityTimePanel.setBorder(BorderFactory
                .createCompoundBorder(BorderFactory
                        .createTitledBorder("Active Time"), BorderFactory
                        .createEmptyBorder(2, 2, 2, 2)));
    ...
    public JPanel createResourceActivityPanel(TimelinePanel timelinePanel) {
        ...
        final TypeFilter typeFilter = new TypeFilter(
                TypeFactory.getType("Order"), true);
        orderCheckBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JCheckBox thisBox = (JCheckBox) e.getSource();
                if (thisBox.isSelected()) {
                    tlinePanel.updateActivityTypeFilter(typeFilter,
                                                        TimelineConstants.ADD);
                    forceMenu.setEnabled(false);
                    mobileMenu.setEnabled(false);
                } else {
                    tlinePanel
                            .updateActivityTypeFilter(typeFilter,
                                                      TimelineConstants.REMOVE);
        ...
        resourcePanel.setBorder(BorderFactory
                .createCompoundBorder(BorderFactory
                        .createTitledBorder("Orders"), BorderFactory
                        .createEmptyBorder(2, 2, 2, 2)));
    ...
    public JPanel createNoResourceActivityPanel(TimelinePanel timelinePanel) {
        ...
        final TypeFilter typeFilter = new TypeFilter(
                TypeFactory.getType("ActorLessActivity"), true);
        ...
        cboxPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
                .createTitledBorder("Events"), BorderFactory
                .createEmptyBorder(2, 2, 2, 2)));
        return cboxPanel;
    }
    ...
    private JPanel createActivitySelectionPanel(TimelinePanel timelinePanel) {
        ...
        activityTypePanel.add(createNoResourceActivityPanel(timelinePanel),
                              BorderLayout.NORTH);
        activityTypePanel.add(createResourceActivityPanel(timelinePanel),
                              BorderLayout.CENTER);
        JPanel activityPanel = new JPanel(new BorderLayout());
        activityPanel.add(activityTypePanel, BorderLayout.NORTH);
        activityPanel.add(createActivityTimeSelectionPanel(timelinePanel),
                          BorderLayout.CENTER);
        activityPanel
                .setBorder(BorderFactory.createCompoundBorder(BorderFactory
                                                                      .createTitledBorder("Activity Selection"),
                                                              BorderFactory
                                                                      .createEmptyBorder(2,
                                                                                         2,
                                                                                         2,
    ...
    public JPanel getTimelineSliderPanel(TimelinePanel timelinePanel) {
        final TimelinePanel tlinePanel = timelinePanel;
        // the slider
        int halfInterval = (int) (tlinePanel.getDisplayedEndTime() - tlinePanel
                .getDisplayedStartTime()) / 2;
        timelineSlider.setMaximum((int) tlinePanel
                .getMaxBoundInCurrentTimeUnit() / halfInterval - 2);
        timelineSlider.setPaintTrack(false);
        timelineSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                long interval = tlinePanel.getDisplayedEndTime()
                        - tlinePanel.getDisplayedStartTime();
        ...
        // the labels
        JLabel forwardLabel = new JLabel(new ImageIcon(
                Client.class.getResource("map/images/fast_forward16.gif")));
        ...
        JLabel backwardLabel = new JLabel(new ImageIcon(
                Client.class.getResource("map/images/fast_back16.gif")));
    ...
    public JToolBar getTimelineTools(TimelinePanel timelinePanel) {
        ...
        JButton addHandOfGod = new JButton(new ImageIcon(
                Client.class.getResource("map/images/addactivity16.png")));
        ...
        JButton addMUActivity = new JButton(new ImageIcon(
                Client.class.getResource("map/images/addmuactivity16.png")));
        ...
        JButton info_button = new JButton(new ImageIcon(
                Client.class.getResource("map/images/Information16.gif")));
        ...
        JButton zoom_in = new JButton(new ImageIcon(
                Client.class.getResource("map/images/zoom_in16.gif")));
        ...
        zoom_in.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int halfInterval = (int) (tlinePanel.getDisplayedEndTime() - tlinePanel
                        .getDisplayedStartTime()) / 2;
                int maxValue = (int) (tlinePanel.getMaxBoundInCurrentTimeUnit()
                        / halfInterval - 2);
        ...
        JButton zoom_out = new JButton(new ImageIcon(
                Client.class.getResource("map/images/zoom_out16.gif")));
    ...
    public JDialog getSelectResourceDialog() {
        ...
        orderBoxPanel.setBorder(BorderFactory
                .createCompoundBorder(BorderFactory
                        .createTitledBorder("Select the order"), BorderFactory
        ...
        muBoxPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory
                .createTitledBorder("Select the resource"), BorderFactory
                .createEmptyBorder(5, 5, 5, 5)));
    ...
    public JDialog getInformationDialog() {
        ...
        step_size_panel.setLayout(new BoxLayout(step_size_panel,
                BoxLayout.LINE_AXIS));
        ...
        step_size_panel.setBorder(BorderFactory
                .createCompoundBorder(BorderFactory
                        .createTitledBorder("Time Step Size"), BorderFactory
                        .createEmptyBorder(2, 5, 2, 5)));
        // set the simulation start time
        JPanel start_time_panel = new JPanel();
        start_time_panel.setLayout(new BoxLayout(start_time_panel,
                BoxLayout.LINE_AXIS));
        ...
        start_time_panel
                .setBorder(BorderFactory.createCompoundBorder(BorderFactory
                                                                      .createTitledBorder("Simulation Start Time"),
                                                              BorderFactory
                                                                      .createEmptyBorder(2,
                                                                                         5,
                                                                                         2,
        ...
        current_time_panel.setLayout(new BoxLayout(current_time_panel,
                BoxLayout.LINE_AXIS));
        currentTimeLabel.setFont(currentTimeLabel.getFont()
                .deriveFont(Font.PLAIN));
        current_time_panel.add(currentTimeLabel);
        current_time_panel.add(Box.createHorizontalGlue());
        current_time_panel
                .setBorder(BorderFactory.createCompoundBorder(BorderFactory
                                                                      .createTitledBorder("Simulation Current Time"),
                                                              BorderFactory
                                                                      .createEmptyBorder(2,
                                                                                         5,
                                                                                         2,
        ...
        content_pane.setOpaque(true);
        content_pane.setBorder(BorderFactory.createCompoundBorder(BorderFactory
    ...
    public void updateDialogInfo() {
        deltatLabel
                .setText(TimelinePanel.millisecondsToString(timeline.getDT(),
                                                            TimelineConstants.LONG));
        startTimeLabel.setText(TimelinePanel.dateFormat.format(new Date(
                timeline.getSimStartTime())));
        currentTimeLabel.setText(TimelinePanel.dateFormat.format(new Date(
