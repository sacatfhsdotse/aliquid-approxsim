...
public class MapConstants {
     ...
     * The force symbols.
     */
    public static final char[] forceSymbols = {'M','L','K','J','I','H','G','F','E','D','C','B','A'};
     ...
     */
    public static final char[] mobileSymbols = {'A','B','C','D','E','F','G','H','K','M'};
    
    /**
     * The agencies.
     */
    public static final String[] agencies = {"Shelter Team", "Water Team", "Health Team", "Food Team", "Police Team", "Custom Team"};
     ...
     * The degree symbol.
     */
    public static String DEGREE_SYMBOL = new String((new Character('\u00B0')).toString());
     ...
     */ 
    public static final char[] affiliationSymbols = {'P', 'U', 'A', 'F', 'N', 'S', 'H', 'J', 'K', 'O'};
    /**
