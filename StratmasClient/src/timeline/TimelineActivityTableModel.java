...
public class TimelineActivityTableModel extends AbstractTableModel implements StratmasEventListener {
     ...
     * The column names.
     */
    private String[] columns = {"Activity", "Start time", "End time", "Resource", "Affiliation"};
    /**
    ...
    /**
     * Adds a new activity to the table. If the table is sorted the activity is inserted such
    ...
    /**
     * Sorts the table. It's sorted with respect to the values of the column where
     * the sorting is initialized.
     *
