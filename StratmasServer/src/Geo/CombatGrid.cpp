...
//                          approxsimDebug(EthnicFaction::faction(j)->ref().name() << " is hostile towards "
...
//                              approxsimDebug(u.ref().name() << " impacts faction " << faction << " with " << unitImpact);
                         }
                         if (c.pvfGet(eInsurgents, faction) * facFactor > 0) {
                              facImpact += c.pvfGet(eInsurgents, faction) * facFactor;
//                                approxsimDebug("### Faction " << faction << " impacts " << u.ref().name() <<
