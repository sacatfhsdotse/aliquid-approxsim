...
#define APPLICATION_NAME               "Stratmas Server"
#define APPLICATION_CODENAME           "stratmas-server"
#define APPLICATION_COPYRIGHT_YEARS    "2014"
#define APPLICATION_VERSION_MAJOR      7
#define APPLICATION_VERSION_MINOR      5
/* #undef APPLICATION_VERSION_PATCH */
#define APPLICATION_VERSION_TYPE       "SNAPSHOT"
#define APPLICATION_VERSION_STRING     "7.5.0-SNAPSHOT"
