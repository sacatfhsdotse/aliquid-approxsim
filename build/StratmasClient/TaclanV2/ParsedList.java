...
/**
 * An object representing a declaration of list of declarations in the
 * Taclan V2 language The members of the list are required to have
 * some common superclass availiable in a provided xsd. As a parsed
 * construct it contains artefacts of the language, e. g. references
 * to the source files
 *
...
public class ParsedList extends ParsedDeclaration
{
    ...
    /**
     * Performs type checking on immidiates (i. e. instances) using
     * the supplied TypeInformation. For a List this means that every
     * member of the list shall pass an ImmidiateTypeCheck against the
     * type.
     *
     * @param definedDeclaration the Declaration this
     * ParsedDeclaration is checked against.
