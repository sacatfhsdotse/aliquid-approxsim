...
/**
 * An object representing the location of a lexical symbol in a parsed
 * source. Mainly used to construct meaningful error-messages.
 *
 * @version 1, 09/28/04
 * @author  Daniel Ahlin
*/
...
public class SourcePosition
{
    ...
    */        
    ...
    /**
     * Creates a new sourceposition using no symbol, just recording
     * where the declaration were made.
     * @param source the source where the token was declared (typically a filename)
     */
