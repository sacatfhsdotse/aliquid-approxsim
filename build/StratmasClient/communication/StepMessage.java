...
/**
 * Class representing the step message. The step message is the
 * message that an active client sends to a server in order to advance
 * the simulation a specified number of timesteps.
 *
...
public class StepMessage extends StratmasMessage {
    ...
    /**
     * Creates a step message - with a specified number of timesteps -
     * that may or may not be executed detached.
     *
     * @param steps The number of timesteps
     * @param detached Should be set to true if the steps are to be
     * executed detached.
     */
