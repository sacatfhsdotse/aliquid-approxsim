...
/**
 * This interface should be implemented by objects that are interested
 * in receiving notifications about what happens with a
 * StratmasMessage. Events are generated when:<p>
 * The message is sent by the client to the server.<p>
 * The answer to the message has been received.<p>
 * The contents of the message has been processed by the XMLHandler<p>
