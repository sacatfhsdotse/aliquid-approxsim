...
/**
 * Abstract class that is the base class of all types of
 * subscriptions.
 *
...
public abstract class Subscription extends XMLHelper {
     ...
     /**
      * Generates a new id. Id.s are generated starting with 1 and
      * increasing with 1 for each subscription created. 
      *
     ...
     /**
      * Returns the tag to be used when producing an xml
      * representation of this subscription.
      *
      * @return The tag to be used when producing an xml
      * representation of this subscription.
      */
