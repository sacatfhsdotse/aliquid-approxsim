...
/**
 * A parameter subclass usable for parameters backed by process
 * variables.
 * 
...
public class ProcessVariableParameter extends DoubleParameter implements SimulationEvaluatorTargetFactory
{
    /**
    ...
    /**
     * Creates a new ProcessVariableParameter defined on the scecified
     * region concerning the specified process variable for the
     * specified faction.
     * 
    ...
    /**
     * Returns a vector containg ProcessVariableDescription's, or null
     * if no process variables have been obtained.
     */
    ...
    /**
     * Sets hashtable containg processVariables as keys and vectors
     * containing factions. Or null if none set using the input form
     * from XMLHandler.
     *
    ...
    /**
     * Returns a menu that on actionPerformed will set the pv and
     * faction for this parameter.
     */
    ...
    /**
     * Shows a dialog that sets faction and pv parameter. Returns
     * false if user cancels the dialog. Else true.
     */
