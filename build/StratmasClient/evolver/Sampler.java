...
/**
 * A sampler provides new ParameterInstanceSets to sample. E. g. if
 * f(x, y) is being maximized and there exist sevaral samples, f'(x[n
 * - 1], y[n - 1]), f'(x[n], y[n]) etc, the sampler returns a set {x[n
 * + 1], y[n + 1]} to evaluate.
 *
