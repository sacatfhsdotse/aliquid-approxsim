...
/**
 * Typefilter filters out StratmasObjects accordning to
 * provided rules.
 *
...
public class TypeFilter extends StratmasObjectFilter
{
    ...
    /**
     * Creates a new TypeFilter allowing the specified type and
     * optionaly its subtypes.
     *
     * @param type the type to filter for.
     * @param substitutionOk if the filter also should pass subtypes
     * of specified type.
     */
    ...
    /**
     * Creates a new TypeFilter allowing the specified types (allowing
     * subtypes).
     *
     * @param type the type to filter for.
     */
