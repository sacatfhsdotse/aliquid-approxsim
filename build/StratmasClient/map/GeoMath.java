...
public class GeoMath {
    ...
    /**
     * Computes great circle distance between two points. The input parameters are assumed 
     * to be degrees.
     *
     ...
     */
    public static double distanceGC(double lat1, double lon1, double lat2, double lon2) {
	...
	double cosD = Math.sin(a)*Math.sin(b)+Math.cos(a)*Math.cos(b)*Math.cos(P);
