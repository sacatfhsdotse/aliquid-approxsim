...
class DefaultComplex extends StratmasObjectDynImpl
{
    ...
    /**
     * Creates a new DefaultComplex from a Declaration and changes the
    ...
    /**
     * Creates a DefaultComplex from the specified Declaration. Each
     * component is given its default value, i.e. it is created by
    ...
    /**
     * Adds a new child object to this object, preserving the order of
     * this object's attributes. If an identical identifier exists,
     * the previous entry is removed. Sets initiator to null.
     *
     * <p>author  Per Alexius
     *
     ...
     * Adds a new child object to this object, preserving the order of
     * this object's attributes. If an identical identifier exists,
     * the previous entry is removed. Generates no add event.
     *
     * <p>author  Per Alexius
     *
     * @param part The StratmasObject to add.
...
//     }
    ...
    /**
     * Convenience method for creating the ActionGroup for adding
     * elements to a list. Goes through the descendant types of the
     * type of this list and groups actions according to that.
     *
     * @param listToAddTo The StratmasList that the elements should be
     * added to.
     * @param declaration The Declaration of the StratmasList to
     * create add actions for. May be the Declaration of the
     * StratmasList to add to or in recursive calls a Declaration with
     * a type that is a descendant to the type of the list.
     *
     * @return An ActionGroup with all the add actions that applies to
