...
/**
 * An object representing a declaration of something in the Taclan type 
 * language.
 *
...
public class Declaration
{
    ...
    /**
     * String representation of any annotation associated with this
     * object.
     */
    ...
    /**
     * Creates a new declaration. Using defaults, name will be the
     * name of the type, minOccurs = maxOccurs = 1 and unbounded = false;
     *
     * @param type the type of the declaration.
     */
    ...
    /**
     * Creates a new declaration. Using defaults, minOccurs =
     * maxOccurs = 1 and unbounded = false;
     *
     * @param type the type of the declaration.
     ...
     * Creates a new declaration.
     *
     * @param particle the particle used to create the
     * declaration. Note that it is an error to pass a particle for
     * which particle.getTerm().getType() !=
    ...
    /**
     * Creates a new declaration. This constructor is a special case
     * for handling directly recursive typeDefinitions.
     *
     * @param particle the particle used to create the
     * declaration. Note that it is an error to pass a particle for
     * which particle.getTerm().getType() !=
    ...
    /**
     * Convinience method that checks if the multiplicity of this
     * declaration is precisly 1.
     */
    ...
    /** 
     * Returns the annotation of this declaration or null if none
     * present
     */
    ...
    /**
     * Returns a copy of this declaration with the specified type as
     * actual type. Behaviour is unspecified if the provided type is
     * not a valid substitution for the type of this declaration.
     *
