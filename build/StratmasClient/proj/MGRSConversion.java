...
/**
 * This class implements the conversion between geodetic values (latitude and longitude) and
 * MGRS coordinates.
 */
public class MGRSConversion {
    ...
    /*
     * This method receives a latitude band letter and uses the latitude_band_table 
     * to determine the minimum northing for that latitude band letter.
     *
    ...
    /*
     * This method receives a latitude band letter and uses the latitude_band_table 
     * to determine the latitude band boundaries for that latitude band letter.
     *
     * @param letter latitude band letter.
     *
     * @return [Northern latitude boundary for that letter,
    ...
    /*
     * This method receives a latitude value and uses the latitude_band_table
    ...
    /*
     * This method receives an MGRS coordinate string.If a zone is 
    ...
    /*
     * This method rounds the input value to the nearest integer, 
     * using the standard engineering rule. The rounded integer value 
     * is then returned.
     *
    ...
    /**
     * This method sets the letter range used for the 2nd letter in the 
     * MGRS coordinate string, based on the set  number of the utm zone. 
     * It also sets the false northing using a value of A for the second 
     * letter of the grid square, based on the grid pattern and set number 
     * of the utm zone.
     *
    ...
    /*
     * This method calculates an MGRS coordinate string based on the zone, 
     * latitude, easting and northing.
     *
    ...
    /*
     * This method receives the ellipsoid parameters and sets the corresponding 
     * state variables.
     *
    ...
    /*
     * This method converts an MGRS coordinate string to Geodetic (latitude and longitude) 
    ...
    /*
     * This method converts an MGRS coordinate string to UTM projection (zone, 
     * hemisphere, easting and northing) coordinates according to the current 
    ...
    /**
     *  This method converts UPS (hemisphere, easting, and northing) coordinates 
     * to an MGRS coordinate string according to the current ellipsoid parameters.
     *
    ...
    /**
     * This method converts an MGRS coordinate string to UPS (hemisphere, easting, 
     * and northing) coordinates, according to the current ellipsoid parameters.
     *
     * @param mgrs MGRS coordinate string.
     *
