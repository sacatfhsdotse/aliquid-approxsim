...
public class RegionData {
    ...
    /**
     * Hashtable mapping pv name to Hashtable mapping faction name (excluding the all faction) to pv value.
     */
     ...
     * 
     * @param reportToWhenDone The Client to report to when the last listener has been removed.
     */
    ...
    /**
     * Accessor for the simulation time for the last update of this object.
     * 
    ...
    /**
     * Adds a listener to this object. Listeners will be notified when the object has been updated.
     * 
    ...
    /**
     * Gets a <b>copy</b> of the Hashtable containing all pv values for all factions.
     * 
     * @return A copy of the Hashtable containing all pv values for all factions.
     */
    public synchronized Hashtable<String, Hashtable<String, Double>> getPV() {
        ...
        for (java.util.Enumeration<String> en = mPV.keys(); en
                .hasMoreElements();) {
    ...
    /**
     * Gets a <b>copy</b> of the Hashtable containing the pv values for all factions for the specified pv.
     * 
     * @param pvName The name of the pv.
     * @return A copy of the Hashtable containing the pv values for all factions for the specified pv.
     */
    public synchronized Hashtable<String, Double> getPV(String pvName) {
        ...
        if (toBeCopied != null) {
            ...
            for (java.util.Enumeration<String> en = toBeCopied.keys(); en
                    .hasMoreElements();) {
                String key = en.nextElement();
    ...
    /**
     * Gets a <b>copy</b> of the specified pv for the specified faction. Returns null if the specified pv or the specified faction does not
     * exist.
     * 
     * @param pvName The name of the pv.
    ...
    public synchronized void update(Element n, Timestamp t) {
        ...
        for (Node child = n.getFirstChild(); child != null; child = child
            ...
            if (child.getNodeType() == Node.ELEMENT_NODE
                ...
                Element factionElem = XMLHandler.getFirstChildByTag(elem,
                                                                    "faction");
                String factionName;
                if (factionElem == null) {
