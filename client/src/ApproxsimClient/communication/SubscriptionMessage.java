...
public class SubscriptionMessage extends ApproxsimMessage {
    ...
    /**
     * Creates a subscription message with the specified initial storage space.
     * 
     * @param initialSize The initial storage space (in number of subscriptions).
     */
     ...
     * 
     * @return true if this message does not contain any subscriptions, false otherwise.
     */
