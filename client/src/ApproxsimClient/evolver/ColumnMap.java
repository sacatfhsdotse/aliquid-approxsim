...
public class ColumnMap {
    ...
    /**
     * Returns the index of the provided Parameter or -1 if none exists.
     * 
    ...
    /**
     * Returns the parameter of the provided index or null if none exists.
     * 
    ...
    /**
     * Returns the parameters of this map in the order of their indexes.
     */
    ...
    public synchronized int[] getIndices() {
        ...
        int i = 0;
        for (Enumeration<Integer> e = indexToParameter.keys(); e
                .hasMoreElements();) {
    ...
    /**
     * Sets the index of the provided Parameter to the specified value, replacing any index existing for that parameter and any parameter
     * existing for that index.
     * 
     * @param parameter the parameter to map
     */
    ...
    /**
     * Returns the current max index. Note that this is not necessarily the number of entries in the tables.
     */
